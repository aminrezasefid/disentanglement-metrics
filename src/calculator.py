...
z_diff_score=metrics.z_diff(lbl_tensor,feat_tensor)
mig_sup_score=metrics.mig_sup(lbl_tensor,feat_tensor)
dci_score=metrics.dci(lbl_tensor,feat_tensor)
print(modularity_score,z_diff_score,mig_sup_score,dci_score)
